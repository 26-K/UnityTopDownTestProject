...
namespace PPD
{
    public static class EX_Transform
    {
        ...
        public static void SetLocalRotateX(this Transform transform, float value)
        {
        ...
        public static void SetLocalRotateY(this Transform transform, float value)
        {
            var v = transform.localEulerAngles;
            v.y = value;
            transform.localEulerAngles = v;
        ...
        public static void SetLocalRotateZ(this Transform transform, float value)
        {
            var v = transform.localEulerAngles;
            v.z = value;
            transform.localEulerAngles = v;
